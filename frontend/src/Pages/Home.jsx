...
//   return (
//     <Box>
//       <Heading mt={2} color={'#034752'}>MOVIES</Heading>
...
//                     <Button  bg={"black"} color={"white"} p={4} _hover={{ bg: "white", color: "black", border:'1px solid black' }}> Watched Movies 
//                     <Text as="span" fontSize={'1rem'} ml={2}><FaHistory /></Text></Button>
//                 </Box>
                
//             </Box>
//             <Grid templateColumns="repeat(3, minmax(300px, 1fr))" gap={3}>
          ...
          <Box w={"90%"} margin={"auto"} mt={"1rem"}>
            <Box w={"95%"} margin={"auto"} display={'flex'} flexDirection={'row'} justifyContent={'flex-end'} mb={4}>
              ...
              <Box m={2} p={2} textAlign={'right'} onClick={watchedMovies}>
                ...
                >
                  Watched Movies
                  <Text as="span" fontSize={'1rem'} ml={2}><FaHistory /></Text>
                </Button>
              </Box>
            </Box>
            <Grid templateColumns="repeat(5, minmax(200px, 1fr))" gap={3}>
              {Array.isArray(movies) && 
                movies.slice(0, 5).map((movie) => (
                  <MovieCard key={movie._id} movie={movie} onDelete={handleMovieUpdate} />
                ))
              }
            </Grid>
          </Box>
